...
Note: You can modify at most three lines in the given code. You cannot add or remove lines of code. To restore the original code, click on the icon to the right of the language selector.

Input Format:

The first line contains t (number of test cases).
The first line of each test case contains an integer n (number of array elements).
